...
;(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \**********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var setArrayLength = __webpack_require__(
          /*! ../internals/array-set-length */ './node_modules/core-js/internals/array-set-length.js'
        )
        var deletePropertyOrThrow = __webpack_require__(
          /*! ../internals/delete-property-or-throw */ './node_modules/core-js/internals/delete-property-or-throw.js'
        )
        var doesNotExceedSafeInteger = __webpack_require__(
          /*! ../internals/does-not-exceed-safe-integer */ './node_modules/core-js/internals/does-not-exceed-safe-integer.js'
        )
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        var nearestEmptyInsertDetectEvent =
        ...
        function Sortable(el, options) {
          ...
          this.nativeDraggable = options.forceFallback
            ? false
            : supportDraggable
        ...
        Sortable.prototype =
          /** @lends Sortable.prototype */
          {
            ...
            closest: function closest$1(el, selector) {
              return closest(
                el,
                selector || this.options.draggable,
                this.el,
                false
              )
            },
            ...
            option: function option(name, value) {
              ...
              if (value === void 0) {
                ...
                var modifiedValue = PluginManager.modifyOption(
                  this,
                  name,
                  value
                )
        ...
        function _generateId(el) {
          var str =
              el.tagName + el.className + el.src + el.href + el.textContent,
            i = str.length,
            sum = 0
            ...
            _handleAutoScroll: function _handleAutoScroll(evt, fallback) {
              ...
              if (
                ...
                if (
                  ...
                  pointerElemChangedInterval &&
                    clearPointerElemChangedInterval() // Detect for pointer elem change, emulating native DnD behaviour
        ...
        function MultiDragPlugin() {
          ...
          MultiDrag.prototype = {
            ...
            dragOverAnimationCapture: function dragOverAnimationCapture(
              _ref11
            ) {
                ...
                if (
                  ...
                  if (!initialFolding) {
                    ...
                    if (oldIndex === index(dragEl$1)) {
                      ...
                      multiDragElements.forEach(function (multiDragElement) {
                        if (
                          multiDragElement.sortableIndex !==
