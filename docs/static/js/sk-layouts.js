    ...
    handleCommand(command) {
      switch (command) {
        ...
        case 'personalCenter':
          ...
          break;
        case 'github':
          window.open('https://github.com/Elwin0204/shark-admin');
          break;
      }
    },
    personalCenter() {
