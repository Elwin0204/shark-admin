...
import $baseEventBus from './bus'
import { getDBInstance } from './localforage'
import { getGenidInstance } from './snowFlake'
...
const install = (Vue, opts = {}) => {
  ...
  /* 全局事件总线 */
  Vue.prototype.$baseEventBus = $baseEventBus
  /* 全局本地存储 */
  Vue.prototype.$dbInstance = getDBInstance()
  /* 全局雪花id生成器实例 */
  Vue.prototype.$genid = getGenidInstance()
}
