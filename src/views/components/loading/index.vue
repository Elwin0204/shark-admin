<template>
  <div class="loading-container">
    ...
    <br />
    <br />
    <el-divider content-position="left">多色loading</el-divider>
    <el-button type="primary" @click="handleColorLoading(1)">效果1</el-button>
    <el-button type="primary" @click="handleColorLoading(2)">效果2</el-button>
    <el-button type="primary" @click="handleColorLoading(3)">效果3</el-button>
    <el-button type="primary" @click="handleColorLoading(4)">效果4</el-button>
  </div>
</template>
