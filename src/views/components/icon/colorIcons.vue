  ...
  <div class="colorful-icon-container">
    ...
    <el-row :gutter="20">
      ...
      >
        ...
        >
          <sk-colorful-icon
            :icon-class="`https://fastly.jsdelivr.net/gh/Elwin0204/sk-color-icons@master/icons/${item}.svg`"
          />
        </el-card>
...
<script>
  import { getIconList } from '@/api/colorIcons'
