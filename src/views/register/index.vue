<template>
  <div class="register-container">
    <el-alert
      ...
      title="beautiful boys and girls欢迎加入shark-adminQQ群：972435319"
      type="success"
      :closable="false"
        ...
        >
          <el-form-item prop="username">
            <el-input
              ...
              auto-complete="off"
            >
              <v-icon slot="prefix" name="user-alt"></v-icon>
            </el-input>
          </el-form-item>
          <el-form-item prop="phone">
            <el-input
              ...
              autocomplete="off"
            >
              <v-icon slot="prefix" name="mobile-alt"></v-icon>
            </el-input>
          </el-form-item>
          <el-form-item prop="phoneCode" style="position: relative">
            <el-input
              ...
              placeholder="手机验证码"
            >
              <v-icon slot="prefix" name="envelope-open"></v-icon>
            </el-input>
            <el-button
              type="primary"
          ...
          <el-form-item prop="password">
            ...
            >
              <v-icon slot="prefix" name="unlock"></v-icon>
            </el-input>
          </el-form-item>
          <el-form-item>
            <el-button
